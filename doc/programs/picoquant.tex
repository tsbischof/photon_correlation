...
\section{Translating T3 data to T2 data}
\begin{verbatim}
...
\section{Mode- and hardware-specific information}
\label{sec:formats}
...
\subsection{A word about external markers}
...
\subsection{T3 timing carries units of histogram bins, not time}
...
\subsection{Translation of T3 to T2 data}
