...
%\section{A brief mathematical background}
...
\subsection{The set $\photons_{\timewindow}$ can be generated efficiently from a time-ordered \photons}
...
\subsection{Generating correlation events (photon tuples) from $\photons_{\timewindow}$}
...
\subsection{Production of the correlation event, given a photon tuple}
...
%\subsection{Definition of the correlation as the order of a set}
...
%\end{equation}
%
%\subsection{Mapping T3 data onto T2-like data}
...
%
%\subsection{Correlation of the time-ordered stream}
