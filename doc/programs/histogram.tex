...
\subsection{Time-averaged photoluminescence lifetime from T3 data}
...
\subsection{The cross-correlations can be enumerated as a base-$\abs{\channels}$ numbers}
...
\subsection{A histogram is function of $n$-dimensional vectors mapping mapping onto integers}
...
\subsection{Printing the histogram}
