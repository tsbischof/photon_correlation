...
Version 1.6
            ...
            -c, --channels: The number of channels in the signal.
               -g, --order: The order of the correlation or histogram.
                -x, --time: The time limits for an axis, following the format:
                                    lower, number of bins, upper
                            with no spaces, and the extrema in picoseconds.
               -y, --pulse: The pulse limits for an axis, following the format:
                                    lower, number of bins, upper
                            with no spaces, and the extrema in picoseconds.
          -X, --time-scale: The scale of the time axis, one of:
         ...
         -Y, --pulse-scale: The scale of the pulse axis, one of:
                               linear: linear interpolation between limits
                                  log: logarithmic interpolation (linear
                                       on a log axis)
                             log-zero: same as log, except that the lowest
